...
!(function (t, e) {
  ...
  function It(t) {
    ...
    return a
      ? Object.assign(
          {},
          A,
          (((T = {})[b] = g ? "0" : ""), (T[_] = m ? "0" : ""), (T.transform = (v.devicePixelRatio || 1) < 2 ? "translate(" + u + "px, " + p + "px)" : "translate3d(" + u + "px, " + p + "px, 0)"), T)
        )
      ...
      fn: function (t) {
        ...
        null != e.modifiersData.popperOffsets &&
          ...
          null != e.modifiersData.arrow &&
            (e.styles.arrow = Object.assign({}, e.styles.arrow, It(Object.assign({}, c, { offsets: e.modifiersData.arrow, position: "absolute", adaptive: !1, roundOffsets: l })))),
      ...
      ? Ft(
          (function (t) {
            var e = ct(t),
              ...
              a = 0;
            return (
              n && ((s = n.width), (o = n.height), /^((?!chrome|android).)*safari/i.test(navigator.userAgent) || ((r = n.offsetLeft), (a = n.offsetTop))), { width: s, height: o, x: r + zt(t), y: a }
            );
          })(t)
        )
      : ht(e)
  ...
  class we extends R {
    ...
    static dataApiKeydownHandler(e) {
      if (
        /input|textarea/i.test(e.target.tagName) ? "Space" === e.key || ("Escape" !== e.key && (("ArrowDown" !== e.key && "ArrowUp" !== e.key) || e.target.closest(".dropdown-menu"))) : !ue.test(e.key)
      )
        return;
